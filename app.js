...
function renderTodayCard(day) {
  ...
  const northCard = `
    <div style="position:relative;overflow:hidden;border-radius:1.5rem;padding:1.5rem 1.5rem 0;display:flex;flex-direction:column;min-height:280px;background:${nt.bg}">
      ...
      <h3 style="position:relative;z-index:10;margin:32px 0 0" class="font-headline text-2xl font-bold ${nt.text}">${ns.desc}</h3>
      <div style="position:relative;z-index:10;display:flex;gap:12px;padding-top:56px;padding-bottom:1.5rem">
  ...
  const southCard = `
    <div style="position:relative;overflow:hidden;border-radius:1.5rem;padding:1.5rem 1.5rem 0;display:flex;flex-direction:column;min-height:280px;background:${st.bg}">
      ...
      <h3 style="margin:32px 0 0" class="font-headline text-2xl font-bold ${st.text}">${ss.desc}</h3>
      <div style="display:flex;gap:12px;padding-top:56px;padding-bottom:1.5rem">
